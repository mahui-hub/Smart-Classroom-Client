<template>
    ...
    <div class="keqiankaoqin-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
                ...
                <div class="detail-content">
                    <p>课程编号：{{ map.kechengbianhao }}</p><p>课程名称：{{ map.kechengmingcheng }}</p><p>课程类型：{{  map.kechengleixing  }}</p>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail(){
                ...
                this.loading = true;
                this.$get(api.keqiankaoqin.detail , {
                    id:this.id
                }).then(res=>{
                    this.loading = false;
