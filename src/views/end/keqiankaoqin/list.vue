        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                    <!--        <el-button @click="$goto('/admin/qiandaoadd?id='+row.id)" type="success" icon="el-icon-plus"
                                       size="mini">
                                签到添加
                            </el-button>
                            <el-button type="info" @click="'/admin/qiandao?keqiankaoqinid='+row.id"
                                       icon="el-icon-search" size="mini">
                                签到查询
                            </el-button>-->
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/keqiankaoqindetail',query:{id:row.id } })"
                                           icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/keqiankaoqinupdt',query:{id:row.id } })"
