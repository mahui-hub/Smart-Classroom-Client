<template>
  <div class="v-list" v-loading="loading" element-loading-text="加载中">
    ...
    <div class="form-search">
      <el-form :model="search" :inline="true" size="mini">
        ...
        <el-form-item label="课程类型">
          <el-select v-model="search.kechengleixing" clearable>
            <el-option :key="m.kechengleixing" v-for="m in kechengleixingList" :value="m.kechengleixing"
        ...
        <el-form-item>
          <el-button type="primary" @click="addSubmit" icon="el-icon-plus">添加课程</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-table border :data="list" highlight-current-row stripe>
      ...
      <el-table-column label="课程类型" prop="kechengleixing" align="center" :formatter="typeformatter">
      </el-table-column>
      <el-table-column label="授课老师" prop="jiaoshiid" align="center" :formatter="typeformatter1">
      </el-table-column>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="{ row }">
          ...
          <el-button @click="edit(row)" type="text" v-if="username==row.faburen">编辑</el-button>
          <!-- <el-button
      ...
      <div class="form-database-form">
        <el-form :model="form" ref="formModel" label-width="100px" :rules="rules">
          <el-form-item label="课程编号" prop="kechengbianhao">
            <el-input disabled placeholder="请输入课程编号" v-model="form.kechengbianhao" />
          </el-form-item>

          <el-form-item label="课程名称" prop="kechengmingcheng">
            <el-input placeholder="请输入课程名称" v-model="form.kechengmingcheng" />
          </el-form-item>
          ...
          <el-form-item label="课程类型" prop="kechengleixing">
            <el-select v-model="form.kechengleixing" style="width: 100%">
              <el-option :key="m.kechengleixing" v-for="m in kechengleixingList" :value="m.id"
                :label="m.kechengleixing"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="班级名称" prop="banjimingcheng">
            ...
            <el-select v-model="form.banjimingcheng" style="width: 100%" @change="handleChange">
              <el-option v-for="m in banjiList" :key="m.id" :value="m.banjimingcheng" :label="m.banjimingcheng">
              </el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="课程视频" prop="kechengshipin" required :rules="[{ required: true, message: '请填写课程视频' }]">
    ...
    <el-dialog title="修改课程信息" :visible.sync="dialogVisible1" size="mini">
      <div class="form-database-form">
        <el-form :model="form1" ref="formModel1" label-width="100px" status-icon validate-on-rule-change>
          <el-form-item label="课程编号" prop="kechengbianhao">
            <el-input disabled placeholder="请输入课程编号" v-model="form1.kechengbianhao" />
          </el-form-item>

          <el-form-item label="课程名称" prop="kechengmingcheng" :rules="[{ required: true, message: '请填写课程名称' }]">
            <el-input placeholder="请输入课程名称" v-model="form1.kechengmingcheng" />
          </el-form-item>

          <el-form-item label="课程类型" prop="kechengleixing" :rules="[{ required: true, message: '请选择课程类型' }]">
          ...
          <el-form-item label="班级名称" prop="banjimingcheng">
            ...
            <el-select v-model="form1.banjimingcheng" style="width: 100%" @change="handleChange1">
              <el-option v-for="m in banjiList" :key="m.id" :value="m.banjimingcheng" :label="m.banjimingcheng">
              </el-option>
            </el-select>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      typeformatter1(row) {
        var name = "";
        this.jiaoshilist.forEach(function (item) {
          if (row.jiaoshiid == item.id) {
            name = item.xingming;
          }
        });
        return name;
