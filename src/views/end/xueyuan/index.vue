    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        ...
        <div class="form-search">
            <el-form :inline="true" size="mini" :label-suffix="':'">
                ...
                <el-form-item>
                    <el-button type="primary" @click="addSubmit" icon="el-icon-plus">添加学院</el-button>
                </el-form-item>
            </el-form>
        </div>
        ...
        <el-dialog title="添加学院" :visible.sync="dialogVisible" size="mini">
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" :rules="rules" label-width="100px">
                    <el-form-item label="学院名称" prop="xueyuan">
                        <el-input placeholder="输入学院名称" v-model="form.xueyuan" />
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog title="编辑学院" :visible.sync="dialogVisible1" size="mini">
            <div class="form-database-form">
                <el-form :model="form1" ref="formModel1" :rules="rules" label-width="100px">
                    <el-form-item label="学院名称" prop="xueyuan">
                        <el-input placeholder="输入学院名称" v-model="form1.xueyuan" />
                    </el-form-item>
                </el-form>
            </div>
            <span slot="footer" class="dialog-footer">
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.xueyuan.list, filter)
                    .then((res) => {
                        this.loading = false;
                        if (res.code == api.code.OK) {
                            extend(this, res.data);
            ...
            submit() {
                this.$refs.formModel
                    ...
                    .then((res) => {
                        ...
                        this.loading = true;
                        var form = this.form;
                        this.$post(api.xueyuan.insert, form)
                            .then((res) => {
                                this.loading = false;
                                if (res.code == api.code.OK) {
            ...
            submit1() {
                this.$refs.formModel1
                    ...
                    .then((res) => {
                        ...
                        this.loading = true;
                        var form = this.form1;
                        this.$post(api.xueyuan.update, form)
                            .then((res) => {
                                this.loading = false;
                                if (res.code == api.code.OK) {
