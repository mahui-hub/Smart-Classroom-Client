<template>
    <div class="suitangceshi-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                <el-page-header @back="$router.go(-1)" content="编辑随堂测试">
                </el-page-header>
            </div>
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="题目" prop="timu">
                        <el-input placeholder="输入题目" style="width:450px;" v-model="form.timu" />
                    </el-form-item>
        ...
        methods: {
            submit() {
                this.$refs.formModel.validate().then(res => {
                    ...
                    this.$post(api.suitangceshi.update, form).then(res => {
                        this.loading = false;
            ...
            loadInfo() {
                ...
                this.loading = true;
                var form = this.form;
                this.$post(api.suitangceshi.edit, {
                    id: this.id
                }).then(res => {
                    this.loading = false;
                    if (res.code == api.code.OK) {
