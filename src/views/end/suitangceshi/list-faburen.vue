    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        ...
        <div class="form-search">
            <el-form @submit.prevent.stop :inline="true" size="mini">
                ...
                <el-form-item>
                    <el-button type="primary" @click="addSubmit" icon="el-icon-plus">添加随堂测试</el-button>
                </el-form-item>
            </el-form>
        </div>
                ...
                <template slot-scope="{row}">
                    <el-button-group>
                        ...
                        <el-tooltip content="详情" placement="top">
                            <el-button @click="$goto({path:'/admin/suitangceshidetail',query:{id:row.id } })"
                                icon="el-icon-info" type="info" size="mini"></el-button>
                        </el-tooltip>
                        <el-tooltip content="编辑" placement="top">
                            <el-button icon="el-icon-edit"
                                @click="$goto({path:'/admin/suitangceshiupdt',query:{id:row.id } })" type="warning"
                                size="mini"></el-button>
                        </el-tooltip>
