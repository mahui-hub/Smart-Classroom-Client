<template>
    ...
    <div class="tiezi-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
                ...
                <div class="detail-content">
                     <e-select-view module="tiezifenlei" :value="map.fenlei" select="id" show="fenleimingcheng"></e-select-view>
                </div>
