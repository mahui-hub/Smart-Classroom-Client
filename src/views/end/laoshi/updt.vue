    ...
    <div class="laoshi-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <el-page-header @back="$router.go(-1)" content="编辑老师">
                </el-page-header>
            </div>


            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
              <!--  <el-form-item label="工号" prop="gonghao" required
                              :rules="[{required:true, message:'请填写工号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'laoshi', col:'gonghao', id:'{{   form.id   }}', trigger:'blur'}]">
                    <el-input placeholder="输入工号" style="width:250px;" v-model="form.gonghao"/>
                </el-form-item>-->
                ...
                <el-form-item label="手机号码" prop="shoujihaoma"
                    ...
                    <el-input placeholder="输入手机号码" style="width:250px;" v-model="form.shoujihaoma"/>
                </el-form-item>
        ...
        methods: {
            submit() {
                this.$refs.formModel.validate().then(res => {
                    ...
                    this.$post(api.laoshi.update, form).then(res => {
                        this.loading = false;
