  ...
  <div class="v-list" v-loading="loading" element-loading-text="加载中">
    ...
    <div class="form-search">
      <el-form :model="search" :inline="true" size="mini">
        ...
        <el-form-item>
          <el-button type="primary" @click="addSubmit" icon="el-icon-plus">添加资源</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-dialog title="添加资源" :visible.sync="dialogVisible" size="mini">
      <div class="form-database-form">
        <el-form :model="form" ref="formModel" label-width="100px" status-icon validate-on-rule-change>
          <el-form-item label="资源编号" prop="bianhao" :rules="[{ required: true, message: '请填写编号' }]">
            <el-input disabled placeholder="请输入编号" v-model="form.bianhao" />
          </el-form-item>
