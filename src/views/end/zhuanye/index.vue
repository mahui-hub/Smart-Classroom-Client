<template>
  <div class="v-list" v-loading="loading" element-loading-text="加载中">
    ...
    >
      ...
      <!-- 序号 -->
      <el-table-column label="专业ID" align="center">
        <template slot-scope="{ row }"> {{ row.zhuanyeID }} </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="{ row }">
          <!-- @click="
                    $goto({ path: '/admin/zhuanyeupdt', query: { id: row.id } })
                  " -->
    ...
    <el-dialog title="添加专业" :visible.sync="dialogVisible" size="mini">
      <div class="form-database-form">
        <el-form
          ...
          label-width="100px"
        >
          <el-form-item label="专业ID" prop="zhuanyeID">
            <el-input placeholder="输入专业ID" v-model="form.zhuanyeID" />
          </el-form-item>
    ...
    <el-dialog title="编辑专业" :visible.sync="dialogVisible1" size="mini">
      <div class="form-database-form">
        ...
        >
          <el-form-item label="专业ID" prop="zhuanyeID">
            <el-input placeholder="输入专业ID" v-model="form1.zhuanyeID" />
          </el-form-item>
          <el-form-item label="专业名称" prop="zhuanye">
