        ...
        <el-table border :data="list" style="width: 100%" highlight-current-row>
            <el-table-column type="index" label="#"></el-table-column> <!-- 序号 -->
                ...
                <template slot-scope="{row}">
                    {{  row.pinglunneirong  }}                </template>
                        ...
                        <el-table-column label="评论人"width="80">
                <template slot-scope="{row}">
            ...
            <el-table-column label="操作">
                <template slot-scope="{row}">
                    ...
                    <el-button icon="el-icon-edit" @click="$goto({path:'/admin/pinglunupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList( page ){
                ...
                this.$post(api.pinglun.listpinglunren , filter).then(res=>{
                    this.loading = false;
