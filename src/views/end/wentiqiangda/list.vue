  ...
  <div class="v-list" v-loading="loading" element-loading-text="加载中">
    ...
    <div class="form-search">
      <el-form :model="search" :inline="true" size="mini">
        ...
        <el-form-item>
          <el-button type="primary" @click="addSubmit" icon="el-icon-plus">发起抢答</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-dialog title="发起抢答" :visible.sync="dialogVisible" size="mini">
      <div class="form-database-form">
        <el-form :model="form" ref="formModel" label-width="120px" status-icon validate-on-rule-change>
          <el-form-item label="抢答编号" prop="bianhao" :rules="[{ required: true, message: '请填写编号' }]">
            <el-input placeholder="请输入编号" disabled v-model="form.bianhao" />
          </el-form-item>
          ...
          <el-form-item label="设置抢答人数" prop="qiangdarenshu" :rules="[
          ...
          <el-form-item label="附件" prop="fujian" v-if="form.changeleixing == '1'">
            <e-upload-file v-model="form.fujian"></e-upload-file>
          </el-form-item>

          <el-form-item label="问题详情" prop="xiangqing" v-if="form.changeleixing == '0'">
