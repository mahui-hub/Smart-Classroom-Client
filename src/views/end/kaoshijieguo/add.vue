        ...
        <el-card class="box-card">
            ...
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="单选题得分" prop="danxuantidefen"
                        :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
                        <el-input placeholder="输入单选题得分" style="width:250px;" v-model="form.danxuantidefen" />
                    </el-form-item>

                    <el-form-item label="多选题得分" prop="duoxuantidefen"
                        :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
                        <el-input placeholder="输入多选题得分" style="width:250px;" v-model="form.duoxuantidefen" />
                    </el-form-item>



                    <el-form-item label="总得分" prop="zongdefen"
                        :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
                        <el-input placeholder="输入总得分" style="width:250px;" v-model="form.zongdefen" />
                    </el-form-item>
