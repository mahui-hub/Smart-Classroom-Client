    ...
    <div class="wentiqiangda-add" v-loading="loading">
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item label="抢答人数" prop="qiangdarenshu" :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
                                            <el-input placeholder="输入抢答人数" style="width:250px;" v-model="form.qiangdarenshu" />                                    </el-form-item>
