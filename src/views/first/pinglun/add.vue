        ...
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                <el-form-item label="评分" prop="pingfen" required :rules="[{required:true, message:'请填写评分'}]">
                                            <el-input placeholder="输入评分" style="width:450px;" v-model="form.pingfen" />                                    </el-form-item>
                                ...
                                <el-form-item label="评论人" prop="pinglunren">
                                            <el-input v-model="form.pinglunren" readonly style="width: 250px;"></el-input>                                    </el-form-item>
