    ...
    <div class="xuesheng-add" v-loading="loading">
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                <el-form-item label="学号" prop="xuehao" required :rules="[{required:true, message:'请填写学号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'xuesheng', col:'xuehao', id:'{{   form.id   }}', trigger:'blur'}]">
...
<el-option v-for="m in zhuanyeList" :value="m.zhuanye" :label="m.zhuanye"></el-option>
                                ...
                                <el-form-item label="QQ号" prop="qqhao">
                                            <el-input placeholder="输入QQ号" style="width:250px;" v-model="form.qqhao" />                                    </el-form-item>
