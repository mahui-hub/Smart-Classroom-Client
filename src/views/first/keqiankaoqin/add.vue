<template>
    <div class="keqiankaoqin-add" v-loading="loading">
        <el-card class="box-card">
         ...
         v-model="form.kechengxinxi" module="kecheng"
          select-update="kechengbianhao,kechengmingcheng,kechengleixing" search-update=""></e-select-list><table>
<tr>
