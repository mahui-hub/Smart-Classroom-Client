    ...
    <div class="huidawenti-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                                    <el-page-header @back="$router.go(-1)" content="编辑回答问题">
                    </el-page-header>
                            </div>
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item label="回答附件" prop="huidafujian">
                                            <e-upload-file v-model="form.huidafujian"></e-upload-file>                                    </el-form-item>
        ...
        data() {
            return {
                ...
                form:{
                    ...
                    biaoti:'',
                    tupian:'',
faburen:this.$store.state.user.session.username,qiangdaren:this.$store.state.user.session.username,                    huidafujian:'',
                    beizhu:'',
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.huidawenti.update , form).then(res=>{
                        this.loading = false;
