          ...
          <template v-if="$session.username">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item icon="el-icon-user-solid" @click.native="end"
                  >个人中心
                </el-dropdown-item>
                <el-dropdown-item icon="el-icon-warning" @click.native="logout"
                  >退出
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    loadListMenu(module, target) {
      this.$post(api.search.all, { table: module, order: "id desc" }).then(
        (res) => {
